...
function draw() {
    ...
    if (windowWidth < 600) {
        botonArriba.show();
        botonAbajo.show();
        botonArriba.position(jugadorX + anchoRaqueta / 2, jugadorY - 210 );  // Ajustado aquí
        botonAbajo.position(jugadorX + anchoRaqueta / 2, jugadorY + altoRaqueta - 200 );  // Ajustado aquí
    }
}
