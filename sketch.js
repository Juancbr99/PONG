...
function draw() {
    ...
    if (windowWidth < 600) {
        botonArriba.show();
        botonAbajo.show();
        botonArriba.position(jugadorX + anchoRaqueta / 2, jugadorY - 100);  // Ajustado aquí
        botonAbajo.position(jugadorX + anchoRaqueta / 2, jugadorY + altoRaqueta - 30 );  // Ajustado aquí
    }
}
