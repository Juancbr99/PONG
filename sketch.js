...
function draw() {
    ...
    if (windowWidth < 600) {
        botonArriba.show();
        botonAbajo.show();
        botonArriba.position(jugadorX + anchoRaqueta / 2 - 15, jugadorY - 120);  // Ajustado aquí
        botonAbajo.position(jugadorX + anchoRaqueta / 2 - 15, jugadorY + altoRaqueta - 50 );  // Ajustado aquí
    }
}
